...
import { Confirm$Params } from './fn/Confirm$Params';
import { Register$Params } from './fn/Register$Params';
import { authenticate } from './fn/authenticate';
import { register } from './fn/Register$Params';
import { confirm } from './fn/Confirm$Params';

@Injectable({
  providedIn: 'root'
})
export class AuthenticatisonService extends BaseService{
